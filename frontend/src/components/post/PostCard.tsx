      ...
      <div className="px-0 py-3 space-y-2.5">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            {/* Like */}
            <div className="flex items-center space-x-1 text-ig-text">
              <Button
                variant="ghost"
                size="icon"
                onClick={handleLikeToggle}
                disabled={isLikeLoading}
                className={`h-9 w-9 p-0 flex items-center justify-center hover:bg-transparent transition-transform active:scale-75 cursor-pointer ${
                  isLiked
              ...
              >
                {isLiked ? (
                  <svg aria-label="Unlike" fill="#ed4956" stroke="#ed4956" strokeWidth="1" className="w-[28px] h-[28px]" viewBox="0 0 24 24">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
                  </svg>
                ) : (
                  <svg aria-label="Like" fill="none" stroke="currentColor" strokeWidth="2" className="w-[28px] h-[28px]" viewBox="0 0 24 24">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
                  </svg>
                )}
              </Button>
            ...
            <div className="flex items-center space-x-1 text-ig-text">
              <Button
                ...
                variant="ghost"
                size="icon"
                className="text-ig-text hover:text-ig-secondary-text hover:bg-transparent h-9 w-9 p-0 flex items-center justify-center transition-transform active:scale-75 hover:scale-110 duration-150 cursor-pointer"
              >
                <svg aria-label="Comment" fill="none" stroke="currentColor" strokeWidth="2" className="w-[28px] h-[28px]" viewBox="0 0 24 24">
            ...
            <div className="flex items-center space-x-1 text-ig-text">
              <Button
                ...
                className="text-ig-text hover:text-ig-secondary-text hover:bg-transparent h-9 w-9 p-0 flex items-center justify-center transition-transform active:scale-75 hover:scale-110 duration-150 cursor-pointer"
              >
                <svg aria-label="Share Post" fill="none" stroke="currentColor" strokeWidth="2" className="w-[28px] h-[28px]" viewBox="0 0 24 24">
                  <line x1="22" y1="2" x2="11" y2="13"></line>
                  <polygon points="22 2 15 22 11 13 2 9 22 2"></polygon>
                </svg>
              </Button>
              <span className="text-sm font-semibold select-none text-ig-text">{sharesCount}</span>
            </div>
          </div>
          ...
          <Button
            ...
            className={`h-9 w-9 p-0 flex items-center justify-center hover:bg-transparent transition-transform active:scale-75 hover:scale-110 duration-150 cursor-pointer ${
              isBookmarked ? "text-ig-text" : "text-ig-text hover:text-ig-secondary-text"
            }`}
          >
            <svg aria-label="Save" fill={isBookmarked ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" className="w-[28px] h-[28px]" viewBox="0 0 24 24">

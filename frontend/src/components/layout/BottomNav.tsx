...
const navItems = [
  ...
  { icon: Send,       to: "/messages",      label: "Pesan",      wip: false },
              ...
              {({ isActive }) => (
                <span className="relative">
                  ...
                  {unreadMessageCount > 0 && (
                    <span className="absolute -right-2 -top-2 min-w-[16px] rounded-full bg-ig-primary px-1 text-center text-[10px] font-bold leading-4 text-white">
